  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {contacts.length > 0 && (
          <div
            style={{ fontSize: "9.5pt", color: "#666666", marginTop: "4pt" }}
          >
            {contacts.map((c, i) => (
              <span key={i}>
                {i > 0 && " · "}
      ...
      <div>
        {paragraphs.map((p, i) => (
          <p key={i} style={{ marginBottom: "10pt", marginTop: 0 }}>
            <BoldText text={p} />
          </p>
        ))}
      </div>
